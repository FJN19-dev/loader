...
task.spawn(function()
    while task.wait(0.2) do
        ...
        pcall(function()
            ...
            -------------------------------------------------
            -- 1️⃣ TELEPORTA DIRETO PRO SPAWN (FORÇA SPAWN)
            -------------------------------------------------
            topos(ThunderSpawn.CFrame * CFrame.new(0, 10, 0))
            task.wait(1)

            -------------------------------------------------
            -- 2️⃣ ESPERA O BOSS APARECER NO WORKSPACE
            -------------------------------------------------
            local boss
            repeat
                task.wait(0.3)
