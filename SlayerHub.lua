...
if EffectContainer then
    ...
    if Death then
        ...
        if success and type(result) == "function" and hookfunction then
            pcall(function()
...
if GuideModule then
    ...
    if success and module and type(module.ChangeDisplayedNPC) == "function" and hookfunction then
        pcall(function()
...
if Util then
    ...
    if CameraShaker then
        local ok, cam = pcall(require, CameraShaker)
        if ok and cam and cam.Stop then
            pcall(function()
                cam:Stop()
            end)
        end
