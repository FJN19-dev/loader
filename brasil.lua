...
spawn(function()
    while task.wait(0.5) do
        if getgenv().AutoFarm then
            -- Espera terminar de ir ao NPC antes de continuar
            if goingToNPC then continue end
            ...
            pcall(function()
                ...
                if not questVisible then
                    ...
                    -- Chama a função para ir ao NPC ou direto para quest
                    gotoQuestNPC()
